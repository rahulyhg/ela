<?php
	...
	if(isset($_POST['add']) && $_POST['add']=="follower" && isset($_POST['id'])) {
		...
		if (mysql_affected_rows()) {
			$increase_album_follower_count_query = "UPDATE streamable_album SET followers = followers + 1 WHERE album_id='$streamable_album_id'";
		...
		$select_total_followers = "SELECT followers FROM streamable_album WHERE album_id='$streamable_album_id'";
